...
namespace BlogCore.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "El {0} debe ser al menos {2} y máximo {1} de caracteres de longitud", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    //Aquí validamoos si los roles existen, si no, se crean
                    ...
                    /////-------------ESTO ES PARA VALIDAR EL EMAILLLLLLLLLLLLL-------------/////
